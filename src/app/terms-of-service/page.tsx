...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Terms of Service | NunezDev',
    description: 'Review the terms and conditions for using NunezDev services, including our client portal and invoicing system.',
    url: 'https://www.nunezdev.com/terms-of-service',
    siteName: 'NunezDev',
    type: 'website',
  },
};
