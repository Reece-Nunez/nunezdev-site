...
import { Check, Sparkles, Zap, Building2, ShoppingCart, Rocket, Wrench, Server, Code2, Shield } from "lucide-react";
  ...
  care: {
    ...
    plans: [
      ...
      },
      {
        ...
        priceMax: "/mo",
        icon: Zap,
        description: "Everything running, plus hands-on time each month",
        features: [
          "Everything in Starter",
          "1 hour/month developer or content time",
