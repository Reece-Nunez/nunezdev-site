          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for a responsive, type-safe UI</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">AWS Amplify</span>
                <span className="text-white/60">auth, GraphQL API, and cloud storage</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Tesseract.js</span>
                <span className="text-white/60">for client-side OCR receipt scanning</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Quagga</span>
                <span className="text-white/60">for barcode scanning and product entry</span>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for interactive expense dashboards</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">jsPDF</span>
                <span className="text-white/60">for tax-ready PDF report generation</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Vite</span>
                <span className="text-white/60">for fast development and optimized builds</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Tailwind CSS 3</span>
                <span className="text-white/60">for clean, responsive styling</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">no more faded receipts in envelopes or shoeboxes</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">OCR scanning and smart categorization replace manual data entry</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">export-ready reports turn days of tax prep into minutes</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">interactive dashboards show exactly where money goes across the operation</p>
                </div>
              </div>
            </div>
          </div>
