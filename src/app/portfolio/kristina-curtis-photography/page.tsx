          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for reliable code</span>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for serverless email backend</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Tailwind CSS</span>
                <span className="text-white/60">for responsive design</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">a portfolio that matches the quality of the photography</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">contact form with reliable serverless email delivery</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">filterable galleries that let the photography shine</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">vendor directory and investment transparency build trust</p>
                </div>
              </div>
            </div>
          </div>
