          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for elegant animations</span>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">new clients finding the salon through search engines</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">inquiries delivered instantly via email</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">a digital presence that matches the in-salon experience</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">new visitors arrive already knowing the services and team</p>
                </div>
              </div>
            </div>
          </div>
