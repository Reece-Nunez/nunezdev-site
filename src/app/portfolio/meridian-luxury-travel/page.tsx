    ...
    <main className="flex min-h-screen flex-col items-center justify-start px-4 pt-32 text-left text-offwhite overflow-hidden">
      ...
      <div className="relative w-full max-w-4xl px-6 z-10 space-y-12">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.4 }}
          variants={fadeInUp}
          className="relative w-full h-64 md:h-96 rounded-2xl overflow-hidden shadow-xl hover:border-yellow/30 transition-all duration-300"
        >
          <Image
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for speed, SEO, and scalability</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Supabase (PostgreSQL + auth)</span>
                <span className="text-white/60">for reliable database management</span>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for secure, automated payments</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Tailwind CSS & Framer Motion</span>
                <span className="text-white/60">for modern, responsive UI</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">saving hours of admin time every week</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">smoother cash flow and fewer errors</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">faster updates and better SEO visibility</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">improved customer satisfaction</p>
                </div>
              </div>
            </div>
          </div>
