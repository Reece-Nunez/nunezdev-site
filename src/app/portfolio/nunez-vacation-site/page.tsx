          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for component-based UI</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for fast builds and hot reload</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Tailwind CSS</span>
                <span className="text-white/60">for responsive styling</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">every direct booking keeps 100% of the revenue with no platform fees</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">a professional web presence independent of third-party platforms</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">richer property detail and area information than any platform listing</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">data-driven pages make adding new properties quick and easy</p>
                </div>
              </div>
            </div>
          </div>
