          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for journal management</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Ubuntu 24.04 LTS</span>
                <span className="text-white/60">for server OS</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">Apache 2.4</span>
                <span className="text-white/60">for web server</span>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/60">for application runtime</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-yellow rounded-full"></span>
                <span className="text-white font-semibold">MariaDB 10.11</span>
                <span className="text-white/60">for database management</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">from manuscript submission to published article, all in one place</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">editorial teams can manage reviews and publications independently</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60">new journals can be added without rebuilding the platform</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-yellow text-2xl">→</span>
                <div>
                  ...
                  <p className="text-white/60">repeatable deployments reduce setup time and human error</p>
                </div>
              </div>
            </div>
          </div>
