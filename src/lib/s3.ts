...
const BUCKET_NAME = process.env.AWS_S3_BUCKET_NAME || 'nunezdev-client-uploads';
...
export function getPublicUrl(key: string): string {
  return `https://${BUCKET_NAME}.s3.${process.env.AWS_S3_REGION || 'us-east-2'}.amazonaws.com/${key}`;
}
