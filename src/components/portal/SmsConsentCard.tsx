      ...
      <div className="flex items-start justify-between gap-4 mb-3">
        ...
        {state.hasPhone ? (
          <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
            ...
            />
            <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-yellow-400/40 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border after:border-slate-300 after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-yellow-400" />
          </label>
        ) : (
